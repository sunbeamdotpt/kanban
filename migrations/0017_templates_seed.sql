...
INSERT INTO board_templates (tenant_id, name, description, columns, is_global, created_by)
VALUES
  ('system', 'Kanban', 'Standard kanban workflow', '[
  ...
  ('system', 'Sprint', 'Agile sprint board', '[
  ...
  ('system', 'Simple', 'Minimal three-column board', '[
